...
// Ejecuta con las variables de entorno configuradas; nunca pegues claves aquí.
...
if (Object.values(firebaseConfig).some((value) => !value)) {
  throw new Error("Falta la configuración de Firebase. Define las variables EXPO_PUBLIC_FIREBASE_*.");
}
